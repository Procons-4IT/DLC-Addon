Public Class clsEmailSetUp
    ...
    Private Sub LoadForm()
        If oApplication.Utilities.validateAuthorization(oApplication.Company.UserSignature, frm_DLC_EmailSetUp) = False Then
            oApplication.Utilities.Message("You are not authorized to do this action", SAPbouiCOM.BoStatusBarMessageType.smt_Error)
            Exit Sub
        End If
        oForm = oApplication.Utilities.LoadForm(xml_DLC_EmailSetUp, frm_DLC_EmailSetUp)
...
#Region "DataBind"
    ...
    Public Sub BindData(ByVal objform As SAPbouiCOM.Form)
        Try
            ...
            sQuery = "Select ""Code"" From ""@Z_DLC_OMAIL"""
...
#Region "Save Email SetUp"
    ...
    Private Sub saveEmailSetUp(ByVal objApplication As SAPbouiCOM.Application, ByVal ocompany As SAPbobsCOM.Company, ByVal oForm As SAPbouiCOM.Form)
        ...
        Try
            oForm.Freeze(True)
            oUserTable = ocompany.UserTables.Item("Z_DLC_OMAIL")
            oDBDSource = oForm.DataSources.DBDataSources.Item("@Z_DLC_OMAIL")
...
#Region "Item Event"
    Public Overrides Sub ItemEvent(ByVal FormUID As String, ByRef pVal As SAPbouiCOM.ItemEvent, ByRef BubbleEvent As Boolean)
        Try
            If pVal.FormTypeEx = frm_DLC_EmailSetUp Then
