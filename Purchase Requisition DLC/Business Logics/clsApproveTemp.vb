...
#Region "Load Form"
    ...
    Private Sub FillDocType(ByVal aForm As SAPbouiCOM.Form)
        ...
        oComboBox.ValidValues.Add("PRD", "Purchase Request DLC")
        oComboBox.ValidValues.Add("MR", "Material Return")
        oComboBox.ValidValues.Add("MRD", "Material Return DLC")
                    ...
                    Case True
                        Select Case pVal.EventType
                            ...
                            Case SAPbouiCOM.BoEventTypes.et_CLICK
                                ...
                                oComboBox = oForm.Items.Item("17").Specific
                                If pVal.ItemUID = "10" Or pVal.ItemUID = "21" Then
                            ...
                            Case SAPbouiCOM.BoEventTypes.et_ITEM_PRESSED
                                ...
                                Select Case pVal.ItemUID
                                    ...
                                    Case "20"
                                        oForm.PaneLevel = 2
                                    Case "23"
                                        oCheckBox = oForm.Items.Item("23").Specific
                                        If oCheckBox.Checked = True Then
                                            oMatrix1 = oForm.Items.Item("21").Specific
                                            oMatrix1.Clear()
...
#Region "Data Events"
    ...
    Public Sub FormDataEvent(ByRef BusinessObjectInfo As SAPbouiCOM.BusinessObjectInfo, ByRef BubbleEvent As Boolean)
        Try
            ...
            If oForm.TypeEx = frm_ApproveTemp And BusinessObjectInfo.BeforeAction = False And BusinessObjectInfo.ActionSuccess = True Then
                oComboBox = oForm.Items.Item("17").Specific
                    ...
                    Case False
                        Select Case BusinessObjectInfo.EventType
                            Case SAPbouiCOM.BoEventTypes.et_FORM_DATA_LOAD
                                oDBDataSource = oForm.DataSources.DBDataSources.Item("@Z_DLC_OAPPT")
...
#Region "Function"
    ...
    Public Function RemoveValidation(ByVal DocType As String, ByVal StrDocEntry As String, Optional ByVal aLeavetype As String = "") As Boolean
        Try
            ...
            Select Case DocType
                Case "EmpLife"
                    strQuery = "Select U_Z_AppStatus from [@Z_HEM2] where U_Z_ApproveId='" & StrDocEntry & "' and U_Z_AppStatus='P'"
                    strQuery = strQuery & "  Union All Select U_Z_AppStatus from [@Z_HEM4] where U_Z_ApproveId='" & StrDocEntry & "' and U_Z_AppStatus='P'"
                Case "LveReq"
                ...
                Case "Train"
                    strQuery = "Select U_Z_AppStatus from [@Z_TRIN1] where U_Z_ApproveId='" & StrDocEntry & "' and U_Z_AppStatus='P'"
                    strQuery = strQuery & " union All Select U_Z_AppStatus from [@Z_ONTREQ] where U_Z_ApproveId='" & StrDocEntry & "' and U_Z_AppStatus='P'"
                Case "TraReq"
                    strQuery = "Select U_Z_AppStatus from [@Z_OTRAREQ] where U_Z_ApproveId='" & StrDocEntry & "' and U_Z_AppStatus='P'"
                Case "Rec"
                    strQuery = "Select U_Z_AppStatus from [@Z_ORMPREQ] where U_Z_ApproveId='" & StrDocEntry & "' and U_Z_AppStatus='P'"
                    strQuery = strQuery & " union All Select U_Z_AppStatus from [@Z_OHEM1] where U_Z_ApproveId='" & StrDocEntry & "' and U_Z_AppStatus='P'"
                Case "ExpCli"
                    strQuery = "Select U_Z_AppStatus from [@Z_EXPCL] where U_Z_ApproveId='" & StrDocEntry & "' and U_Z_AppStatus='P'"
            End Select
            '   strQuery = "Select * from [@Z_DLC_APHIS] where U_Z_ADocEntry='" & StrDocEntry & "' and U_Z_DocType='" & DocType & "'"
    ...
    Public Function ValidateAuthorizer(ByVal DocType As String, ByVal StrDocEntry As String, Optional ByVal aLeaveType As String = "") As Boolean
        Try
            ...
            Select Case DocType
                Case "EmpLife"
                    strQuery = "Select U_Z_AppStatus from [@Z_HEM2] where (U_Z_CurApprover='" & StrDocEntry & "' or U_Z_NxtApprover='" & StrDocEntry & "') and U_Z_AppStatus='P'"
                    strQuery = strQuery & "  Union All Select U_Z_AppStatus from [@Z_HEM4] where  (U_Z_CurApprover='" & StrDocEntry & "' or U_Z_NxtApprover='" & StrDocEntry & "') and U_Z_AppStatus='P'"
                Case "LveReq"
                    strQuery = "Select U_Z_Status from [@Z_PAY_OLETRANS1] where U_Z_TrnsCode='" & aLeaveType & "' and   (U_Z_CurApprover='" & StrDocEntry & "' or U_Z_NxtApprover='" & StrDocEntry & "') and U_Z_Status='P'"
                Case "Train"
                    strQuery = "Select U_Z_AppStatus from [@Z_TRIN1] where   (U_Z_CurApprover='" & StrDocEntry & "' or U_Z_NxtApprover='" & StrDocEntry & "') and U_Z_AppStatus='P'"
                    strQuery = strQuery & " union All Select U_Z_AppStatus from [@Z_ONTREQ] where   (U_Z_CurApprover='" & StrDocEntry & "' or U_Z_NxtApprover='" & StrDocEntry & "') and U_Z_AppStatus='P'"
                Case "TraReq"
                    strQuery = "Select U_Z_AppStatus from [@Z_OTRAREQ] where   (U_Z_CurApprover='" & StrDocEntry & "' or U_Z_NxtApprover='" & StrDocEntry & "') and U_Z_AppStatus='P'"
                Case "Rec"
                    strQuery = "Select U_Z_AppStatus from [@Z_ORMPREQ] where  (U_Z_CurApprover='" & StrDocEntry & "' or U_Z_NxtApprover='" & StrDocEntry & "') and U_Z_AppStatus='P'"
                    strQuery = strQuery & " union All Select U_Z_AppStatus from [@Z_OHEM1] where   (U_Z_CurApprover='" & StrDocEntry & "' or U_Z_NxtApprover='" & StrDocEntry & "') and U_Z_AppStatus='P'"
                Case "ExpCli"
                    strQuery = "Select U_Z_AppStatus from [@Z_EXPCL] where   (U_Z_CurApprover='" & StrDocEntry & "' or U_Z_NxtApprover='" & StrDocEntry & "') and U_Z_AppStatus='P'"
            End Select
            '   strQuery = "Select * from [@Z_DLC_APHIS] where U_Z_ADocEntry='" & StrDocEntry & "' and U_Z_DocType='" & DocType & "'"
            oRecordSet.DoQuery(strQuery)
            If oRecordSet.RecordCount > 0 Then
        ...
        Try
            ...
            Select Case aForm.PaneLevel
                Case "3"
                    ...
                    oDBDataSourceLines_2 = oForm.DataSources.DBDataSources.Item("@Z_DLC_APPT2")
                ...
                Case "2"
                    ...
                    oDBDataSourceLines_2 = oForm.DataSources.DBDataSources.Item("@Z_DLC_APPT3")
                    oMatrix.FlushToDataSource()
                    For count = 1 To oDBDataSourceLines_2.Size
                        oDBDataSourceLines_2.SetValue("LineId", count - 1, count)
                    Next
...
#Region "Delete Row"
    Private Sub RefereshDeleteRow(ByVal aForm As SAPbouiCOM.Form)
        Try
            oDBDataSourceLines_2 = oForm.DataSources.DBDataSources.Item("@Z_DLC_APPT2")
            oDataSrc_Line = oForm.DataSources.DBDataSources.Item("@Z_DLC_APPT3")
...
#Region "Validations"
    Private Function validation(ByVal aForm As SAPbouiCOM.Form) As Boolean
        Try
            ...
            Select Case oComboBox.Selected.Value
                Case "PR", "MR", "PRD", "MRD"
                    oCheckBox = aForm.Items.Item("23").Specific
            ...
            strQuery = "Select 1 As 'Return',DocEntry From [@Z_DLC_OAPPT]"
            strQuery += " Where "
            ...
            End If
            If strValue = "Y" Then
                strQuery = "Select 1 As 'Return',DocEntry,U_Z_Code From [@Z_DLC_OAPPT]"
                strQuery += " Where "
                strQuery += " U_Z_DocType = '" & oComboBox.Selected.Value & "' And DocEntry <> '" & oApplication.Utilities.getEdittextvalue(aForm, "12") & "' and U_Z_AllDept='" & strValue & "'"
                oRecordSet.DoQuery(strQuery)
                If Not oRecordSet.EoF Then
                    oApplication.Utilities.Message("All department already mapped in Code:" & oRecordSet.Fields.Item("U_Z_Code").Value, SAPbouiCOM.BoStatusBarMessageType.smt_Error)
                    aForm.Freeze(False)
                    Return False
                End If
            End If
            ...
            For i As Integer = 1 To oMatrix.RowCount
                ...
                If oEditText.Value <> "" Then ' CType(oMatrix.Columns.Item("V_0").Cells.Item(i).Specific, SAPbouiCOM.EditText).Value <> "" Then
                    oRecordSet = oApplication.Company.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset)
                    strQuery = "Select 1 As 'Return' From [@Z_DLC_APPT3] T0 inner join [@Z_DLC_OAPPT] T1 on T0.DocEntry=T1.DocEntry"
                    strQuery += " Where "
                    strQuery += " T1.U_Z_Code <> '" & oApplication.Utilities.getEdittextvalue(aForm, "4") & "' and T1.U_Z_DocType ='" & oComboBox.Selected.Value & "'"
                    strQuery += " And T0.U_Z_DeptCode = '" + CType(oMatrix.Columns.Item("V_0").Cells.Item(i).Specific, SAPbouiCOM.EditText).Value + "' and T1.U_Z_Active='Y'"
                    oRecordSet.DoQuery(strQuery)
                    If oRecordSet.RecordCount > 0 Then
